...
$NAV_identity_icon = "https://raw.githubusercontent.com/yaarian-om/SERVER/main/1010110010/Rookie_Recruit_Job_MarketPlace/_Identity.gif";
$NAV_test_icon = "";
//=============================================== Page Links =======================================================
...
$NAV_Blog_page = "/Rookie_Recruit_Job_Marketplace/view/blog/All_Blogs_Applicant.php";
$NAV_dashboard_page =  "/Rookie_Recruit_Job_Marketplace/view/applicant/Applicant_Dashboard.php";
$NAV_my_profile_page = "/Rookie_Recruit_Job_Marketplace/view/applicant/Applicant_profile.php";
$NAV_example_page =  "/Rookie_Recruit_Job_Marketplace/view/admin/";
$NAV_create_payments_applicant = "/Rookie_Recruit_Job_Marketplace/view/payment/Payment_Create_Applicant.php";
$NAV_Identity_Submit_Page = "/Rookie_Recruit_Job_Marketplace/view/Identity_Verification_Applicant.php";
    ...
    <div class="drawer_a bg-light border-right p-4" style="position: fixed;  left: 0; height: 100%; overflow-y: auto; z-index: 1000;">
        ...
        <ul class="list-group">
            ...
            <li  class="list-group-item d-flex align-items-center">
                ...
                <a style="cursor: pointer" href="<?php echo $NAV_create_payments_applicant;?>" class="text-dark">Payment</a>
            </li>
            <li  class="list-group-item d-flex align-items-center">
                <img style="margin-right: 5px" height="20" width="20" src="<?php echo $NAV_identity_icon; ?>" alt="">
                <a style="cursor: pointer" href="<?php echo $NAV_Identity_Submit_Page;?>" class="text-dark">Identity Submit</a>
            </li>
