...
//============================================= IMAGE LINKS ====================================================
    ...
    $NAV_users_icon = "https://raw.githubusercontent.com/yaarian-om/SERVER/main/1010110010/Rookie_Recruit_Job_MarketPlace/_Users.gif";
...
//=============================================== Page Links =======================================================
    ...
    $NAV_dashboard_page =  "/Rookie_Recruit_Job_Marketplace/view/admin/Admin_Dashboard.php";
    $NAV_my_profile_page = "/Rookie_Recruit_Job_Marketplace/view/admin/Admin_Profile.php";
    $NAV_example_page =  "/Rookie_Recruit_Job_Marketplace/view/admin/";
    $NAV_all_payments_admin = "/Rookie_Recruit_Job_Marketplace/view/payment/All_Payments_Admin.php";
...
<div class="drawer_container">
    ...
    <div class="drawer_a bg-light border-right p-4" style="position: fixed;  left: 0; height: 100%; overflow-y: auto; z-index: 1000;">
        ...
        <ul class="list-group">
            ...
            <li  class="list-group-item d-flex align-items-center">
                <img style="margin-right: 5px" height="20" width="20" src="<?php echo $NAV_users_icon; ?>" alt="">
                <a style="cursor: pointer" href="<?php echo $NAV_users_page;?>" class="text-dark">Users</a>
            </li>
            <li  class="list-group-item d-flex align-items-center">
                <img style="margin-right: 5px" height="20" width="20" src="<?php echo $NAV_payment_icon; ?>" alt="">
                <a style="cursor: pointer" href="<?php echo $NAV_all_payments_admin;?>" class="text-dark">Payments</a>
            </li>
<!--            <li  class="list-group-item d-flex align-items-center">-->
