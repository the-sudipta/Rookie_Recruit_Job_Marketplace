...
$HR_Signup_service_file = "/Rookie_Recruit_Job_Marketplace/controller/hr/HRSignupService.php";
    ...
    <div class="login_signup_a">
        ...
        <div class="tab-content">
            ...
            <div class="" id="pills-register" role="tabpanel" aria-labelledby="tab-register">
                ...
                <!-- Signup Form -->
                <!-- Signup Form -->
                <form action="<?php echo $HR_Signup_service_file;?>" method="post">
                    ...
                    <!-- Company Name input -->
                    <div class="form-outline mb-4">
                        <input type="text" id="company_name" name="registerCompany_name" class="form-control" />
