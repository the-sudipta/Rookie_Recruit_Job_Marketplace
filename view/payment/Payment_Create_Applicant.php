                            ...
                            <div class="card-body p-4">
                                <form id="payment_form" action="<?php echo $Payment_service_file;?>" method="post">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="form-outline">
                                            <input type="text" id="card_number" name="card_number" class="form-control form-control-lg" size="17"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        <div class="form-outline">
                                            <input type="text" id="username" name="holder_name" class="form-control form-control-lg" size="17"
                                    ...
                                    <div class="d-flex justify-content-between align-items-center pb-2">
                                        ...
                                        <div class="form-outline">
                                            <input type="password" id="pass" name="cvv" class="form-control form-control-lg"
